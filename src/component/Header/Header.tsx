...
const Header = () => {
    const userActivate = useSelector<Verify>((state) => state.UserActivate.value) // Стейт, который смотрит на автризацию польователя и отрисовывает меню хедера 
    ...
    return (
        <>
            <header className={`${styles.header} containerup`}>
                <Link href='/' className={styles.header_logo}>Logo</Link>
                {
                    !userActivate ?
                        <>
                            <div className={styles.header_list}>
                                {
                                    mainMenu.map((menu) =>
                                        pathname === '/' ?
                                            <Link key={menu.title} href={menu.path} className={styles.header_list_el}>{menu.title}</Link>
                                            :
                                            <Link key={menu.title} href='/' className={styles.header_list_el}>{menu.title}</Link>
                                    )
                                }
                            </div>
                            <div className={styles.header_start}>
                                <Link href='/login' className={styles.header_login}>Войти</Link>
                                <Link href='/signup' className={styles.header_signup}>Зарегистрироваться</Link>
                            </div>
                        ...
                        <>
                            ...
                            <div className={styles.header_start}>
                                ...
                                <Link href='/profile' className={styles.header_profile}>
